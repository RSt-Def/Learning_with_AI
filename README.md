# Learning-with-AI ([ENG](#english-version) & [UA](#ukrainian-version))
...
1. [Вступ](#вступ)
2. [Що таке ШІ (Штучний Інтелект)](#що-таке-ші-штучний-інтелект)
3. [ChatGPT від OpenAI](#chatgpt-від-openai)
4. [Переваги і недоліки](#переваги-і-недоліки)
5. [Ризики та запобігання ризикам](#ризики-та-запобігання-ризикам)
6. [Висновки](#висновки)
